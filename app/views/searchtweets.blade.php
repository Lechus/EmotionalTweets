    ...
    <body class="dark-page">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9 tweets-panel">
                ...
                <div class="col-md-3">
                    <div class="score-panel">
                        ...
                        <hr />
                        <div class="row-fluid">
                            <div class="col-xs-4"><img src="/img/analysis-face-1.png" alt="-" class="img-responsive" /></div>
                            <div class="col-xs-4"><img src="/img/analysis-face-2.png" alt="0" class="img-responsive" /></div>
                            <div class="col-xs-4"><img src="/img/analysis-face-3.png" alt="+" class="img-responsive" /></div>
